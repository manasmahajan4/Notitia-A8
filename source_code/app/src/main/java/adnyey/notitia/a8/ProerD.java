...
public class ProerD {
    ...
    ProerD(Context conti, BasicInfo basic, ProNObj Info) {
        ...
        try {
            if (CommonStuff.engineFinder(basic.getEng()) != -1)
                eng = CommonStuff.engineFinder(basic.getEng());
        ...
        if (basic.getType() == 4) {
            ...
            if (basic.getCarclass() == 1) {
                tire = R.drawable.part_d_tire;
                susp = R.drawable.part_d_susp;
                drive = R.drawable.part_d_drive;
                exha = R.drawable.part_d_exha;
            } else if (basic.getCarclass() == 2) {
                tire = R.drawable.part_c_tire;
                susp = R.drawable.part_c_susp;
                drive = R.drawable.part_c_drive;
                exha = R.drawable.part_c_exha;
            } else if (basic.getCarclass() == 3) {
                tire = R.drawable.part_b_tire;
                susp = R.drawable.part_b_susp;
                drive = R.drawable.part_b_drive;
                exha = R.drawable.part_b_exha;
            } else if (basic.getCarclass() == 4) {
                tire = R.drawable.part_a_tire;
                susp = R.drawable.part_a_susp;
                drive = R.drawable.part_a_drive;
                exha = R.drawable.part_a_exha;
            } else if (basic.getCarclass() == 5) {
                tire = R.drawable.part_s_tire;
                susp = R.drawable.part_s_susp;
                drive = R.drawable.part_s_drive;
                exha = R.drawable.part_s_exha;
            }
        }
    ...
    void partimager(ProNObj Info, Context conti) {
    ...
    void engimager(ProNObj Info, Context conti) {
    ...
    void techimager(ProNObj Info, Context conti) {
        ...
        try {
            ...
            if (Info.getTechn2() > 0) {
                ...
                else if (Info.getTech21() == 50 && Info.getTech22() == 50) {
                    engimgt2.setVisibility(VISIBLE);
                    engimgs2.setVisibility(GONE);
                    engimgd2.setVisibility(VISIBLE);
                    engimge2.setVisibility(GONE);
